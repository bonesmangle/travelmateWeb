            	...
            	<div class="col-sm-12 col-md-8 col-lg-10">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <x-input-field label="Destination Name" name="destination_name" id="destination_name" type="text" disabled="true" 
                                            :value="old('destination_name', $application->destination_name ?? '')" />
                                        
                                        <x-input-field label="Category" name="category" id="category" type="text" disabled="true" 
                                        ...
                                        <x-input-field label="Destination Address" name="destination_address" id="destination_address" type="text" disabled="true" 
                                            :value="old('destination_address', $application->destination_address ?? '')" />
                                    </div>
                                    <div class="col-md-6">
                                        <x-input-field label="Nearest Landmark 1" name="nearest_landmark1" id="nearest_landmark1" type="text" disabled="true" 
                                            :value="old('nearest_landmark1', $application->nearest_landmark1 ?? '')" />
                                        <x-input-field label="Nearest Landmark 2" name="nearest_landmark2" id="nearest_landmark2" type="text" disabled="true" 
                                            :value="old('nearest_landmark2', $application->nearest_landmark2 ?? '')" />
                                        <x-input-field label="Nearest Landmark 3" name="nearest_landmark3" id="nearest_landmark3" type="text" disabled="true" 
